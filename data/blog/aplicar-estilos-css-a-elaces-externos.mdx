...
tags: ['css']
draft: false
summary: Aprende a utilizar selectores de atributos en css. En este caso los usamos para añadir un icono a todos los enlaces externos de nuestro sitio web.
images: ['/static/images/aplicar-estilos-css-a-elaces-externos.jpg']
layout: PostSimple
authors: ['default']
---
